        ...
        <div class="BloquePrincipalDiv">
            ...
            <div class="TituloFormularioDiv">     <!-- Div para el formulario -->
                <div class="TituloFormDiv"> <!-- Div para el formulario y titulo de la sala -->
                    <h3 id="TituloSala">Formulario de acogida</h3>   <!-- Titulo de la sala -->
                </div>    
                <div class="FormularioDiv">
                    <form action="./acogido.php" method="POST" id="formulario" onsubmit="return DatosValidos()"> <!-- ¡CUIDADO! reservado.html está puesto como algo meramente ilustrativo, hay que preguntar que poner -->
                        <div class="InputDiv">
                        ...
                        <div class="InputDiv">
                            <label for="idanimal">Animal:</label> <!-- Introducir sala -->
                            <select id="idanimal" name="idanimal" oninput="return cambiarInfo()">
                                <?php
                                    ...
                                    {
                                        $query = 'SELECT IdAnimal,Nombre FROM TablaAnimal WHERE IdAnimal NOT IN (SELECT AdoptaId FROM TablaAdoptante) AND (IdAnimal NOT IN (SELECT AcogeId FROM TablaVoluntario WHERE FECHAACOGIDAFINALIZADA IS NULL) AND IdAnimal NOT IN (SELECT AcogeId FROM TablaVoluntario WHERE FECHAACOGIDAFINALIZADA > SYSDATE))';
                        ...
                        <input type="submit" name="Enviar" id="enviar" value="Acoger" class="form-submit-button">  <!-- Introducir boton de enviar -->
                    </form>
                </div>
