    ...
    if($_POST)
    {
        ...
        if (!$conn) {
            ...
            try
            {
                ...
                $plsql = "BEGIN PaqueteGlobal.CrearSocio('$Id', '$Cuenta', '$Cuota'); END;";  
                ...
                if(!$flag2)
                {
                    throw new OCIException('La persona ya es socio',501);
                }
            ...
            catch(OCIException $e)
            {
                if($e->getCode() === 501)
                {
                    $resultado = "<div id=\"Resultado\"><p>Error: La persona ya es socio</p></div>";
                    echo $resultado;
                }
                ...
                {
                    $resultado = "<div id=\"Resultado\"><p>Error: No se ha podido realizar el registro</p></div>";
                    echo $resultado;
                }
            }
            // Liberar recursos
