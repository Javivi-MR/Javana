    ...
    <?php
        ...
        if($_POST)
        {
            ...
            if (!$conn) {
                ...
                try
                {
                    $plsql = "BEGIN PaqueteGlobal.ActualizarAdministrador($Id,'$contrasena'); END;";
                    ...
                    if(!$flag1)
                    {
                        throw new OCIException('La persona no esta registrada o ya es admin',499);
                    }        
    
                    $resultado = "<div id=\"Resultado\"><p> ¡El admin ahora cambió de contraseña! </p></div>";
                    echo $resultado;
                }
                catch(OCIException $e)
                {
                    if($e->getCode() === 499)
                    {
                        $resultado = "<div id=\"Resultado\"><p>Error: La persona no esta registrada o no es admin </p></div>";
                        echo $resultado;
                    }
                    else
                    {
