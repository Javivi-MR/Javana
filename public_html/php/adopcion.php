    ...
    if($_POST)
    {
        ...
        if (!$conn) {
            ...
            try
            {
                ...
                $plsql = "BEGIN PaqueteGlobal.AdoptarAnimal('$Id', '$IdAnimal', SYSDATE); END;";  
                ...
                $resultado = "<div id=\"Resultado\"><p> La adopción ha sido exitosa, puede recoger al animal en nuestras oficinas en un plazo de 24 horas. </p></div>";
                echo $resultado;
            }
