    ...
    if($_POST)
    {
        ...
        if (!$conn) {
            ...
            try
            {
                ...
                if($IdAnimal === '-1')
                {
                    throw new OCIException('No ha seleccionado ningún animal',498);
                }
                ...
                $plsql = "BEGIN PaqueteGlobal.FinalizarAcogidaAnimal('$Id', '$IdAnimal', '$Fecha'); END;";  
                ...
                if(!$flag2)
                {
                    throw new OCIException('El animal no estaba acogido por la persona',503);
                }

                $resultado = "<div id=\"Resultado\"><p> La fecha de fin ha sido registrada. Por favor el dia '$Fecha' traiga al animal a nuestro espacio </p></div>";
                echo $resultado;
            }
            catch(OCIException $e)
            {
                ...
                {
                    $resultado = "<div id=\"Resultado\"><p>Error: La persona no tiene acogido al animal seleccionado </p></div>";
                    echo $resultado;
                }
                else
                {
