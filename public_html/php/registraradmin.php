    ...
    <?php
        ...
        if($_POST)
        {
            ...
            if (!$conn) {
                ...
                try
                {
                    $plsql = "BEGIN PaqueteGlobal.DarDeAltaAdministrador($Id,'$contrasena'); END;";
                    ...
                    $resultado = "<div id=\"Resultado\"><p> ¡La persona ahora es admin! </p></div>";
                    echo $resultado;
                }
                catch(OCIException $e)
                {
                    if($e->getCode() === 499)
                    {
                        $resultado = "<div id=\"Resultado\"><p>Error: La persona no esta registrada o ya es admin </p></div>";
                        echo $resultado;
                    }
                    else
                    {
