        ...
        <div class="BloquePrincipalDiv">
            ...
            <div class="TituloFormularioDiv">     <!-- Div para el formulario -->
                ...
                <div class="FormularioDiv">
                    <form action="./adopcion.php" method="POST" id="formulario" onsubmit="return DatosValidos()"> <!-- ¡CUIDADO! reservado.html está puesto como algo meramente ilustrativo, hay que preguntar que poner -->
                        <div class="InputDiv">
                        ...
                        <div class="InputDiv">
                            ...
                            <select id="idanimal" name="idanimal" oninput="return cambiarInfo()">
                                <?php
                                    ...
                                    {
                                        $query = 'SELECT IdAnimal,Nombre FROM TablaAnimal WHERE IdAnimal NOT IN (SELECT AdoptaId FROM TablaAdoptante)';
                        ...
                        <input type="submit" name="Enviar" id="enviar" value="Adoptar" class="form-submit-button">  <!-- Introducir boton de enviar -->
                    </form>
                </div>
                <!--informacion acerca de los datos -->
                <p class="InfoExtra">*Al pulsar el botón de "Adoptar" acepta los términos y condiciones de la página, además del tratamiento de sus datos.</p>     
            </div>
        </div>
    </main>
